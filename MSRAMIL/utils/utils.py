...
def get_simple_loader(dataset, batch_size=1, num_workers=1):
	kwargs = {'num_workers': 8, 'pin_memory': False, 'num_workers': num_workers} if device.type == "cuda" else {}
	# loader = DataLoader(dataset, batch_size=batch_size, sampler = sampler.SequentialSampler(dataset), collate_fn = collate_MIL_heatmap, **kwargs)
